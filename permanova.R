...
permanova_bal$year.after.disturbance <- as.factor(permanova_bal$year.after.disturbance)
...
pirateplot(formula = P ~ year.after.disturbance + pairs,
           data = permanova_bal,
           theme = 3,
           pal = cbpal,
...
pirateplot(formula = F ~ year.after.disturbance + pairs,
           data = permanova_bal,
           theme = 3,
           pal = cbpal,
